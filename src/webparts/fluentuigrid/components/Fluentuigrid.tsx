...
import styles from './Fluentuigrid.module.scss';
import { IFluentuigridProps } from './IFluentuigridProps';
...
export interface IFluentuigridState {
  columns: IColumn[];
  items: IDocument[];
...
export default class Fluentuigrid extends React.Component<IFluentuigridProps,IFluentuigridState, {}> {
  private _selection: Selection;
  private _allItems: IDocument[];

  constructor(props:IFluentuigridProps,state: IFluentuigridState) {
    super(props);
  ...
  public render(): React.ReactElement<IFluentuigridProps> {
  ...
  public componentDidUpdate(previousProps: any, previousState: IFluentuigridState) {
  ...
  private _onChangeText = (ev: React.FormEvent<HTMLInputElement | HTMLTextAreaElement>, text: string): void => {
    this.setState({
      items: text ? this._allItems.filter(i => i.name.toLowerCase().indexOf(text) || i.fileSize.toLowerCase().indexOf(text) || i.fileType.toLowerCase().indexOf(text) ||  i.modifiedBy.toLowerCase().indexOf(text) ||  i.dateModified.toLowerCase().indexOf(text)> -1) : this._allItems,
    });
  };
